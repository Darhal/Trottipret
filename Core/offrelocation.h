...
/*
 * Classe OffreLocation qui represente les offres de location propose par les propio
*/
class OffreLocation
{
public:
    ...
    // Des setteur inline c'est ultra rapide!
    // On a respecté les principes de programmation objet orienté: encapsulations
    ...
    // Des getteur inline c'est ultra rapide!
    // On a respecté les principes de programmation objet orienté: encapsulations
...
private:
    // Des variables definis dans le temp de compilation qui indique les index de debut et fin.
